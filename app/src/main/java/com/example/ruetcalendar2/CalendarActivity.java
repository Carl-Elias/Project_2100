...
public class CalendarActivity extends AppCompatActivity {
    ...
    Button add, showrout, clear,resource;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resource = findViewById(R.id.button5);
        ...
        resource.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/drive/folders/1UcCpHhTEaRykc1u3UTyXAAPbPQM4zWtT?fbclid=IwAR25zY4o65P9HjHTD-wON5-xvFhjsZ7DefQpNO8EzdJar4IeXvCPRGO1YE8"));
